...
def preprocess_text(text):
    ...
    conectores = ['que', 'se', 'la', 'del', 'esta', 'el', 'no', 'las', 'ya', 'me', 'otros', 'el', 'yo', 'ser', 
...
# Datos de ejemplo
# Ejemplo de uso
nombre_archivo = 'estaciones.xlsx'
...
num_temas = 4  # Número de temas a identificar
max_iter = 500
lda_model = LatentDirichletAllocation(n_components=num_temas, random_state=100, max_iter=max_iter)

lda_model.fit(matrix_de_caracteristicas)

# Obtener las características más importantes para cada tema
num_caracteristicas = 15  # Número de características más importantes para mostrar
...
# Guarda el modelo LDA
joblib.dump(lda_model, 'modelo_lda.pkl')
